...
const TOOLS_NOTE =
	"You have read-only access to the ln-ashlar repository (source code, tests, docs, and DOCTRINE.md). " +
	"Inspect the repository files using read tools to verify component implementations, doctrine rules, SCSS " +
	"architecture, and patterns referenced in the plan. Ground your critique in the actual codebase and doctrines. " +
